...
source("C://Users/mpalmore1/OneDrive - Johns Hopkins/ECHO/Analysis_proposals/EC0413c/ALR/alr_from_deicode.R")
```
...
```{r}
alr(features = test_otus, coords = coords_test, pc = "PC1")
```
...
Sample1 ALR should be log2(6/2) = 1.584963

Sample2 ALR should be log2(5/2) = 1.321928

Sample3 ALR should be log2(4/2) = 1

Sample4 ALR should be log2(1/1) = 0

Sample5 ALR should be log2(1/1) = 0

Sample6 ALR should be log2(2/1) = 1

Sample7 ALR should be log2(5/3) = 0.7369656
